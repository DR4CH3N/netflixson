    ...
    <SafeAreaView>
      <ScrollView>
        <Text style={estilos.titulo}>
          Política de Privacidade para o app Netflixson
        </Text>

        <Text style={estilos.subtitulo}>subtitulo teste</Text>

        <Text style={estilos.texto}>
          A sua privacidade é importante para nós. É política do Netflixson
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site Netflixson, e outros sites que possuímos e
          operamos.
        </Text>
        ...
        <Text style={estilos.texto}>
          ...
          informação que o Netflixson oferece no site e com caráter enunciativo,
          mas não limitativo:
        </Text>
        <Text style={estilos.texto}>
        ...
        <Text style={estilos.texto}>
          ...
          (softwares) do Netflixson, de seus fornecedores ou terceiros, para
